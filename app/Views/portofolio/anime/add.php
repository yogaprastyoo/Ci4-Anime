...
<form class=" d-flex justify-content-center" action="/anime/save" method="post" enctype="multipart/form-data">
    <div class=" card border-dark mt-4 mb-3 bg-transparent" style="max-width: 740px;">
        <div class="row g-0">
            <div class="col-md-4" id="imagePreview" onmousedown='return false' oncontexmenu='return false' onselectstart='return false'>
                <img src="/img/anime/default.jpg" class="img-fluid rounded-start image-preview__image" width="600px" alt="...">
            </div>
            <div class="col-md-8">
                <div class="card-body mt-3">
                    ...
                    <table class="table mt-3">
                        <tbody>
                            ...
                            <tr>
                                <th scope="row"><label for="cover">Cover</label></th>
                                <td>
                                    :
